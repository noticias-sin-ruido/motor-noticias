...
**Estado: versión 1.1.0** — las 5 fases completas y la entrega al back-end probada punta a punta. La 1.1.0 cerró los puntos 1, 2, 10 y 12 del backlog (ingesta por URL, motor de IA desacoplado, token de operador y logging). Lo que sigue está en el backlog priorizado de `specs/roadmap.md`.
